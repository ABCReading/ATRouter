...
Pod::Spec.new do |s|
  s.name             = 'ATRouter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ATRouter.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Spaino/ATRouter'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Spaino' => 'captain_spaino@163.com' }
  s.source           = { :git => 'https://github.com/Spaino/ATRouter.git', :tag => s.version.to_s }
